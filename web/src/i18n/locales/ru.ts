    ...
    settings: {
      ...
      device: {
        ...
        usbIdentity: {
          ...
          description: 'Изменить отображение устройства в диспетчере устройств',
          preset: 'Пресет',
          custom: 'Свой',
          vid: 'Vendor ID',
          pid: 'Product ID',
          ...
          save: 'Сохранить',
          saveSuccess: 'Настройки сохранены. Перезагрузите для применения.',
          saveFailed: 'Не удалось сохранить настройки',
          rebootRequired: 'Требуется перезагрузка для применения изменений'
        },
        mdns: {
